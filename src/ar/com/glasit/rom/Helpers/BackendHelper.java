...
public class BackendHelper {
    ...
    public static void setLoggedUserName(String user) {
        ContextHelper.putSharedPrefenrece(BackendHelper.PREF_NAME, BackendHelper.USER_NAME, user);
    }

    public static String getLoggedUserName(){
        return ContextHelper.getSharedPrefenrece(BackendHelper.PREF_NAME, BackendHelper.USER_NAME);
    }
